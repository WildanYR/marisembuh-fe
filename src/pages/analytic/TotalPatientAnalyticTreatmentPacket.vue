...
import {
  ...
  getTotalPatientAnalyticTreatmentPacketByName,
  getTotalPatientAnalyticTreatmentPacketPagination,
...
const getTotalPatientAnalyticDataByQuery = () => {
  ...
  getTotalPatientAnalyticTreatmentPacketByName(searchQuery.value, {
    startDate,
    endDate,
  })
    .then((response) => {
    ...
    >
      <div class="flex gap-3">
        ...
        <h1 class="text-2xl font-medium">
          Daftar Paket Perawatan (Jumlah Pasien)
        </h1>
      </div>
    </div>
    <div class="mt-5">

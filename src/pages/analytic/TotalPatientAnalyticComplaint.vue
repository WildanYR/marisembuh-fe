...
import {
  ...
  getTotalPatientAnalyticComplaintByName,
  getTotalPatientAnalyticComplaintPagination,
...
const getTotalPatientAnalyticDataByQuery = () => {
  ...
  getTotalPatientAnalyticComplaintByName(searchQuery.value, {
    startDate,
    endDate,
  })
    .then((response) => {
  ...
  <div class="p-8 bg-white rounded-lg">
    ...
    >
      <div class="flex gap-3">
        ...
        <h1 class="text-2xl font-medium">Daftar Keluhan (Jumlah Pasien)</h1>
      </div>
    </div>
    <div class="mt-5">

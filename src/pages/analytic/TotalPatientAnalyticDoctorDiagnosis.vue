...
import {
  ...
  getTotalPatientAnalyticDoctorDiagnosisByName,
  getTotalPatientAnalyticDoctorDiagnosisPagination,
...
const getTotalPatientAnalyticDataByQuery = () => {
  ...
  getTotalPatientAnalyticDoctorDiagnosisByName(searchQuery.value, {
    startDate,
    endDate,
  })
    .then((response) => {
    ...
    >
      <div class="flex gap-3">
        ...
        <h1 class="text-2xl font-medium">
          Daftar Diagnosa Dokter (Jumlah Pasien)
        </h1>
      </div>
    </div>
    <div class="mt-5">

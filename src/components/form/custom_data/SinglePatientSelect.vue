...
const patientList: Ref<IPatientResponse[]> = ref([]);
...
const selectedItemIndex = computed(() => {
  if (!props.modelValue || !patientList.value.length) return -1;
  return patientList.value.findIndex(
...
const getPatient = (page = 1, limit = 21) => {
...
const closeModal = () => {
  if (loadingAddPatient.value) return;
        ...
        >
          ...
          >
            ...
            >
              ...
              <template v-else-if="patientList.length">
                <div
                  class="grid grid-cols-1 gap-3 lg:grid-cols-3 md:grid-cols-2"
                >
                  <button
                  ...
                  >
                    ...
                    <p class="text-sm font-medium">
                      {{
                        item.register_clinic ? item.register_clinic.name : ""
                      }}
                    </p>
